...
import Properties from "./assets/property-insurance.png";
import Apartments from "./assets/apartment.png";
import Houses from "./assets/house.png";
import Villas from "./assets/villa.png";
import AuP from "./assets/AboutusParagraph.png";
import Neighbourhood from "./assets/PropertyBanner.png";
import Agent1 from "./assets/TerrellNorman1.png";
import LMAB from "./assets/LM-ab.png";
    ...
    <div className="abtus">
      ...
      <div className="learn-more">
        ...
        <div className="lm-image">
          <img id="lm-image" src={LMAB} alt="Learn More" />
        </div>
      </div>
